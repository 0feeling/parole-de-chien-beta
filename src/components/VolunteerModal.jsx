export default function VolunteerModal({ volunteer, setIsModalOpen }) {
  return (
    <div className="fixed z-30 top-0 left-0 w-full h-full flex flex-col items-center justify-center">
      ...
      <div className="relative z-50 bg-white p-6 shadow-xl rounded-md max-w-[90%] sm:max-w-[60%] md:max-w-[50%]">
        {/* Croix pour fermer */}
        <button
          className="absolute top-[-20px] right-[-20px] p-4 text-[rgb(212,93,0)] hover:text-orange-600 focus:outline-none"
          onClick={() => setIsModalOpen(false)}
        >
          <svg
        ...
        <div className="flex flex-col items-center">
          ...
          <h4 className="text-lg text-gray-600 italic">Bénévole</h4>
        </div>
      </div>
    </div>
  );
